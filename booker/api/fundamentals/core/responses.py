...
from booker.api.fundamentals.core.response_codes_information import get_code_information
from booker.api.fundamentals.model.pong import Pong
...
def patch_response(status_code: int, request_body: Pong):
    return __response(status_code,
                      method="PATCH",
                      request_body=request_body)


def delete_response(status_code: int, request_body: Pong):
    return __response(status_code,
                      method="DELETE",
                      request_body=request_body)
